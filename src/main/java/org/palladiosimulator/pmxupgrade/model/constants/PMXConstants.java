...
public class PMXConstants {
    ...
    public static final String ERROR_RECONSTRUCT_TRACE = "Error while reconstructing the tracing data:";
    ...
    public static final String ERROR_BUILDER = "Builder not initialized";
