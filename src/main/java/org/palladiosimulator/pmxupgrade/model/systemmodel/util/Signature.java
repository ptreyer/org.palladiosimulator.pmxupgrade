...
public class Signature {
     ...
     * @param modifierList  The list of modifiers of the operation.
     * @param returnType    The return type of the operation. If this parameter is null, the return type will be set to {@link #NO_RETURN_TYPE}
     * @param paramTypeList The list of parameters of the operation.s
     */
    ...
    public final boolean hasReturnType() {
        return !this.returnType.equals(NO_RETURN_TYPE);
    }
