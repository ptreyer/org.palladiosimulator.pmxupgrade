...
public class AssemblyRepository extends AbstractSystemSubRepository {
    ...
    private final Map<String, AssemblyComponent> assemblyComponentInstancesByName = new Hashtable<>();
    private final Map<Integer, AssemblyComponent> assemblyComponentInstancesById = new Hashtable<>();
